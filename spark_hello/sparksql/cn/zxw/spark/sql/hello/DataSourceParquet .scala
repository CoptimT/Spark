...
object DataSourceParquet  {
  def main(args: Array[String]): Unit = {
    val sc = new SparkContext("local[2]","DataSourceParquet")
    ...
    val df1 = sqlContext.read.parquet("C:\\zhangxw\\workSpace\\Spark\\spark_hello\\file\\users.parquet")
    //val df1 = sqlContext.read.load("C:\\zhangxw\\workSpace\\Spark\\spark_hello\\file\\users.parquet")
    df1.show()
